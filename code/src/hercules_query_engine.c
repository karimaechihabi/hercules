			       ...
			       query_settings q_settings)
{
    ...
    pthread_t threadid[q_settings.num_query_threads];
    ...
    pthread_barrier_init(&lock_barrier, NULL, q_settings.num_query_threads);
    ...
    */
    ...
    for (i = 0; i < q_settings.num_query_threads; i++)
    {
				  ...
				  query_settings q_settings)
{
    ...
    //creating maxquerythread threads
    pthread_t threadid[q_settings.num_query_threads];
    struct siss_query_worker_data qwdata[q_settings.num_query_threads];
    ...
    for (i = 0 ; i < num_nodes; ++i)
    {
      ...
      free(n);
        ...
        for (int i = 0; i < q_settings.num_query_threads; i++)
    {
...
//	 if (second_level_pruning < 0.90 )
	 ...
	 */
	 ...
	 unsigned int total_read_threads =  q_settings.num_query_threads * q_settings.num_read_threads;
