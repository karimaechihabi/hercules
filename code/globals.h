...
#ifndef hercules_globals_h
#define hercules_globals_h
...
#define MAXREADTHREADS 1
#define MAXQUERYTHREADS 24
#define N_PQUEUE 1
#define DETAILED_STATS 1
#define READ_BLOCK_LENGTH 20000
#define LOCK_SIZE 2
#define BUSYWAIT_THRESHOLD 1000
#define FLUSH_THRESHOLD 1

double threads_total_input_time[MAXQUERYTHREADS];
double threads_total_realdist_time[MAXQUERYTHREADS];
double threads_total_insert_node_time[MAXQUERYTHREADS];
double threads_total_random_io[MAXQUERYTHREADS];
double threads_total_sequential_io[MAXQUERYTHREADS];
double threads_queries_total_time;

int cur_max_level;
int leaves_count_max_level;
int cur_leaves_count_max_level;
boolean start_parallel_condition ;
int num_fbl_nodes;
struct hercules_node ** fbl_nodes;
