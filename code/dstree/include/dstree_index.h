...
struct stats_info {
	...
	double idx_pre_traverse_tree_total_time ;	
	double idx_pre_traverse_tree_input_time;
	double idx_pre_traverse_tree_output_time;
	double idx_pre_traverse_tree_cpu_time;

	unsigned long idx_pre_traverse_tree_seq_input_count;
	unsigned long idx_pre_traverse_tree_seq_output_count;
	unsigned long idx_pre_traverse_tree_rand_input_count ;
	unsigned long idx_pre_traverse_tree_rand_output_count ;
	...
	double query_pre_calc_ed_dist_total_time ;	
	double query_pre_calc_ed_dist_input_time;
	double query_pre_calc_ed_dist_output_time;
	double query_pre_calc_ed_dist_cpu_time;
	double query_pre_calc_ed_dist_load_node_time;

	unsigned long query_pre_calc_ed_dist_seq_input_count;
	unsigned long query_pre_calc_ed_dist_seq_output_count;
	unsigned long query_pre_calc_ed_dist_rand_input_count ;
	unsigned long query_pre_calc_ed_dist_rand_output_count ;

	double query_calc_ed_dist_total_time ;	
	double query_calc_ed_dist_input_time;
	double query_calc_ed_dist_output_time;
	double query_calc_ed_dist_cpu_time;
	double query_calc_ed_dist_load_node_time;

	unsigned long query_calc_ed_dist_seq_input_count;
	unsigned long query_calc_ed_dist_seq_output_count;
	unsigned long query_calc_ed_dist_rand_input_count ;
	unsigned long query_calc_ed_dist_rand_output_count ;

	double query_pre_calc_sax_mindist_total_time ;	
	double query_pre_calc_sax_mindist_input_time;
	double query_pre_calc_sax_mindist_output_time;
	double query_pre_calc_sax_mindist_cpu_time;
	double query_pre_calc_sax_mindist_load_node_time;

	unsigned long query_pre_calc_sax_mindist_seq_input_count;
	unsigned long query_pre_calc_sax_mindist_seq_output_count;
	unsigned long query_pre_calc_sax_mindist_rand_input_count ;
	unsigned long query_pre_calc_sax_mindist_rand_output_count ;


	double query_calc_sax_mindist_total_time ;	
	double query_calc_sax_mindist_input_time;
	double query_calc_sax_mindist_output_time;
	double query_calc_sax_mindist_cpu_time;
	double query_calc_sax_mindist_load_node_time;

	unsigned long query_calc_sax_mindist_seq_input_count;
	unsigned long query_calc_sax_mindist_seq_output_count;
	unsigned long query_calc_sax_mindist_rand_input_count ;
	unsigned long query_calc_sax_mindist_rand_output_count ;
        ...
        unsigned long *  leaves_coaccesses;  
        unsigned long *  leaves_accesses;  
  ...
  */
	...
	unsigned long long query_total_loaded_ts_count;
        ...
        unsigned long long query_total_ed_dist_count;
        ...
        unsigned long  query_total_coaccessed_leaves_count;
        unsigned long  query_total_contiguous_coaccessed_leaves_count;
