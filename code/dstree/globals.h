...
//#ifdef BENCHMARK
        ...
        unsigned long contiguous_coaccessed_leaves_count;
        unsigned long coaccessed_leaves_count;
        unsigned long access_order;
        unsigned long euclidean_dist_count;
        ...
        #define INIT_STATS() total_input_time = 0;\
			     ...
			     checked_ts_count = 0;\
                             ...
                             coaccessed_leaves_count = 0;\
                             contiguous_coaccessed_leaves_count = 0;\
                             access_order = 1;\
                             euclidean_dist_count = 0;\
                             total_ts_count = 0;
...
*/
        ...
        #define DELETE_LEAF_NODE(num_nodes) --total_nodes_count;\
                                            --leaf_nodes_count; 
        ...
        #define COUNT_COACCESSED_LEAVES ++coaccessed_leaves_count;
        #define COUNT_CONTIGUOUS_COACCESSED_LEAVES ++contiguous_coaccessed_leaves_count;
        #define COUNT_ED_DIST(num_calc) euclidean_dist_count +=num_calc; //euclidean distance calculations
