						   ...
						   float minimum_distance)
{
	...
	struct query_result result = exact_search(query_ts, query_ts_reordered, query_order, offset, index, minimum_distance);	
...
enum response dstree_query_leaves_binary_file(const char *ifilename, int q_num, struct dstree_index *index,
						   float minimum_distance)
{
    RESET_PARTIAL_COUNTERS()
    COUNT_PARTIAL_TIME_START
	...
	struct query_result result = exact_search_leaves_file(query_ts, query_ts_reordered, query_order, offset, index, minimum_distance);	
...
enum response dstree_serial_query_leaves_binary_file(const char *ifilename, int q_num, struct dstree_index *index,
						   float minimum_distance)
{
    RESET_PARTIAL_COUNTERS()
    COUNT_PARTIAL_TIME_START
	...
	struct query_result result = exact_serial_search_leaves_file(query_ts, query_ts_reordered, query_order, offset, index, minimum_distance);	
