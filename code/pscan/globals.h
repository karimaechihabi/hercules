...
//#ifdef BENCHMARK
        ...
        struct timeval partial_dist1_time_start;
        struct timeval partial_dist2_time_start;

        double partial_time;
        double partial_input_time;
        double partial_output_time;
        double partial_load_node_time;
        double partial_dist1_time;
        double partial_dist2_time;
        ...
        #define INIT_STATS() total_input_time = 0;\
			     ...
			     partial_dist1_time = 0;\
			     partial_dist2_time = 0;\			     
...
*/
      ...
      #define RESET_PARTIAL_COUNTERS() partial_seq_output_count = 0;\
       ...
       #define PRINT_PARTIAL_COUNTERS() printf("seq_output and partial_time = %llu and %f\n",partial_seq_output_count,  partial_time);
        ...
        #define COUNT_PARTIAL_DIST1_TIME_START gettimeofday(&partial_dist1_time_start, NULL);   
        #define COUNT_PARTIAL_DIST2_TIME_START gettimeofday(&partial_dist2_time_start, NULL);
        ...
        #define COUNT_PARTIAL_DIST1_TIME_END gettimeofday(&current_time, NULL); \
                                      tS = partial_dist1_time_start.tv_sec*1000000 + (partial_dist1_time_start.tv_usec); \
				      tE = current_time.tv_sec*1000000  + (current_time.tv_usec); \
                                      partial_dist1_time += (tE - tS);
        #define COUNT_PARTIAL_DIST2_TIME_END gettimeofday(&current_time, NULL); \
                                      tS = partial_dist2_time_start.tv_sec*1000000 + (partial_dist2_time_start.tv_usec); \
				      tE = current_time.tv_sec*1000000  + (current_time.tv_usec); \
                                      partial_dist2_time += (tE - tS);
