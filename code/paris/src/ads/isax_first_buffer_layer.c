...
struct first_buffer_layer * initialize_fbl(unsigned long long initial_buffer_size, unsigned long long number_of_buffers,
                                           unsigned long long max_total_buffers_size, isax_index *index) 
{
    ...
    unsigned long long hard_buffer_size = (unsigned long long)(index->settings->sax_byte_size + index->settings->position_byte_size) * (unsigned long long) max_total_buffers_size;
    fbl->hard_buffer = malloc(hard_buffer_size);

	fprintf(stderr, "max_total_buffers_size: %llu\n", max_total_buffers_size);
...
struct parallel_first_buffer_layer * initialize_pRecBuf(unsigned long long initial_buffer_size, unsigned long long number_of_buffers,
                                           unsigned long long max_total_buffers_size, isax_index *index) 
{
    ...
    // Allocate a big chunk of memory to store sax data and positions
    unsigned long long hard_buffer_size = (long long)(index->settings->sax_byte_size + index->settings->position_byte_size) * (unsigned long long) max_total_buffers_size;
    //fbl->hard_buffer = malloc(hard_buffer_size);
...
struct first_buffer_layer2 * initialize_simrec(unsigned long long initial_buffer_size, unsigned long long number_of_buffers,
                                           unsigned long long max_total_buffers_size, isax_index *index) 
{
...
struct parallel_dfirst_buffer_layer * initialize_2pRecBuf(unsigned long long initial_buffer_size, unsigned long long number_of_buffers,
                                           unsigned long long max_total_buffers_size, isax_index *index) 
{
